    ...
    content: (
      <div className='text-center'>
        <div className='relative inline-block'>
          <div className='absolute -inset-2 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full blur-xl opacity-50 animate-pulse'></div>
    ...
    content: (
      <div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mb-6'>
          <div className='bg-red-50 p-6 rounded-lg border border-red-200 shadow-lg'>
  ...
  // Slide 4: Solution
  {
    ...
    content: (
      <div className='text-center'>
        ...
        <div className='bg-gradient-to-r from-blue-50 to-indigo-100 p-6 rounded-lg mb-8 border border-blue-200 shadow-xl'>
    ...
    content: (
      <div className='text-center'>
        ...
        <div className='bg-gray-50 p-6 rounded-lg'>
          ...
          <p className='text-lg text-gray-700 underline'><a href="mailto:asem@qaffaf.com">asem@qaffaf.com</a></p>
          
          <Link href='/features' className='text-lg text-blue-600 hover:underline mt-2 inline-block'>
            Explore the Demo
          </Link>
        </div>
    ...
    <div className='bg-gray-100 min-h-screen flex flex-col items-center justify-center p-2 sm:p-4 font-sans'>
      <div className='w-full max-w-5xl bg-white rounded-lg shadow-2xl overflow-hidden'>
        ...
        <div className='flex items-center justify-between p-4 bg-gray-50 border-b border-gray-200'>
          ...
          <Link href='/features' className='text-gray-400 hover:text-gray-600'>
